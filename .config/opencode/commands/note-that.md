---
description: Capture current session state to the active thought stream before /new
---

Capture current session state to the active thought stream before `/new`. Preserves mission continuity.
...
Call this before `/new` or when switching tasks. The captured state lets you resume seamlessly later.
