...
Skills are located at `~/.claude/skills/`. Use the `skill` tool to load them.
...
You delegate commits and PRs to the Secretary agent. Read `~/.config/opencode/secretary-contract.md` before your first delegation in a session.
