...
2. **plan_triage**
   ...
   - Assess completeness per `~/.config/opencode/plan-completeness-routing.md`.
   - Route:
...
5. **implementation**
   ...
   - See ~/.config/opencode/incremental-review-commit-ranges.md.
...
- `~/.config/opencode/team-lead-contracts.md` (source of truth)
...
- `~/.config/opencode/secretary-contract.md`
</secretary_delegation>
