...
You are invoked by a scheduled task. When you finish — successfully or by finding no viable
...
These come from the scheduled task prompt. If any are missing, exit with a clear error message.
